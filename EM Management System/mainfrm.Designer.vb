...
Partial Class mainfrm
    ...
    Private Sub InitializeComponent()
        ...
        Me.工单编辑ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        Me.工单目录ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        Me.工单顺序ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        Me.检查表编辑ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        Me.借料编辑ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        ...
        Me.工单查询ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        Me.已送工单查询ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        Me.工单上线查询ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        ...
        'Column2
        '
        Me.Column2.FillWeight = 105.5838!
        Me.Column2.HeaderText = "已投"
        Me.Column2.ImageLayout = System.Windows.Forms.DataGridViewImageCellLayout.Zoom
        Me.Column2.MinimumWidth = 20
        Me.Column2.Name = "Column2"
        Me.Column2.ReadOnly = True
        '
        'Column3
        '
        Me.Column3.FillWeight = 105.5838!
        Me.Column3.HeaderText = "上线"
        ...
        'Column4
        '
        Me.Column4.FillWeight = 105.5838!
        Me.Column4.HeaderText = "木箱"
        ...
        'Column5
        '
        Me.Column5.FillWeight = 105.5838!
        Me.Column5.HeaderText = "组装"
        ...
        'Column6
        '
        Me.Column6.FillWeight = 105.5838!
        Me.Column6.HeaderText = "入库"
        ...
        Me.ImageList1.Images.SetKeyName(0, "d1.png")
        Me.ImageList1.Images.SetKeyName(1, "77444.png")
        Me.ImageList1.Images.SetKeyName(2, "dairuku.png")
        Me.ImageList1.Images.SetKeyName(3, "wei.png")
        '
        'Panel1
        '
        ...
        Me.ImageList2.Images.SetKeyName(0, "b7.png")
        Me.ImageList2.Images.SetKeyName(1, "b1.png")
        Me.ImageList2.Images.SetKeyName(2, "accept-database.png")
        Me.ImageList2.Images.SetKeyName(3, "organization.png")
        '
        'TabControl2
        '
        ...
        '
        Me.DataGridViewImageColumn1.HeaderText = "已投"
        Me.DataGridViewImageColumn1.Image = Global.EM_Management_System.My.Resources.Resources.PNG__319_1
    ...
    Friend WithEvents 新用户注册ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 密码重置ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 用户权限ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 工具ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 帮助ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 库位查询ToolStripMenuItem As ToolStripMenuItem
    ...
    Friend WithEvents 借料编辑ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 工单管理ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 查询ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 工单查询ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 已送工单查询ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 工单上线查询ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 借料数据ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 借料用户ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents 工单目录ToolStripMenuItem As ToolStripMenuItem
